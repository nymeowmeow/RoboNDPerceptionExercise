...
def compute_hist(ch1, ch2, ch3, nbins=32, bins_range=(0,256)):
    print 'nbins',nbins
    #create normalized histogram features from the 3 input channels
...
def compute_color_histograms(cloud, using_hsv=False):
    ...
    normed_features = compute_hist(ch1=channel_1_vals,
                                   ch2=channel_2_vals,
                                   ch3=channel_3_vals
                                   )
...
def compute_normal_histograms(normal_cloud):
    ...
    # Generate random features for demo mode.  
    # Replace normed_features with your feature vector
    normed_features = compute_hist(ch1=norm_x_vals,
                                        ch2=norm_y_vals,
                                        ch3=norm_z_vals
                                        )
